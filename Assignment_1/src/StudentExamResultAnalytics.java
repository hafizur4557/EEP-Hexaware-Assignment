...
public class StudentExamResultAnalytics {
    ...
    public static void main(String[] args) {
        ...
        List<Student> students = Arrays.asList(
                new Student(101, "Arnav", "Java", 82, true),
                new Student(102, "Bharat", "Java", 45, false),
                new Student(103, "Chandu", "Python", 91, true),
                new Student(104, "Deepjyoti", "Java", 67, true),
                new Student(105, "Elina", "Python", 38, false),
                new Student(106, "Fathima", "DevOps", 74, true),
                new Student(107, "Gouhar", "DevOps", 88, true),
                new Student(108, "Hariharan", "Java", 53, true),
                new Student(109, "Ishika", "Python", 79, true),
                new Student(110, "Jonny", "DevOps", 62, true),
                new Student(111, "Kamalika", "Java", 95, true),
                new Student(112, "Lotus", "Python", 49, false)
        );
